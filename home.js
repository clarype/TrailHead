(function ($) {
    ...
    $.fn.storymap = function(options) {
        ...
        var makeStoryMap = function (element, markers, polylines) {     // Here is a part of the test (polylines) //
            ...
            function showMapView(key) {
                ...
                if (key === 'overview') {
                    ...
                    var polyline = polylines[key];      // Here is a part of the test (polylines) //
                    if (typeof layer !== 'undefined') {
                        fg.addLayer(layer);
                    }
                    fg.addLayer(L.marker([marker.lat, marker.lon]));

                    fg.addLayer(L.polyline([polyline.lat, polyline.lon]));    // Here is a part of the test (polylines) //
